...
namespace Quartz.NET.Example.Repository.Migrations
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SchedName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ...
                    SomeProp1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SomeProp2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobProperty = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobConfigs", x => new { x.SchedName, x.JobName, x.JobGroup });
                    table.ForeignKey(
                        name: "FK_JobConfigs_QRTZ_JOB_DETAILS_SchedName_JobName_JobGroup",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextJobName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NextJobGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NextJobType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NextJobConfigs", x => new { x.SchedName, x.JobName, x.JobGroup });
                    table.ForeignKey(
                        name: "FK_NextJobConfigs_JobConfigs_SchedName_JobName_JobGroup",
                        columns: x => new { x.SchedName, x.JobName, x.JobGroup },
                        principalTable: "JobConfigs",
